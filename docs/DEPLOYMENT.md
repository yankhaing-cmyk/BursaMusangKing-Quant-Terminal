...
8. Phase 2 restores and saves the private research SQLite database through GitHub Actions cache and retains each run artifact for 30 days. A private R2 archive remains the recommended later durability upgrade; never make raw histories or research databases public.
