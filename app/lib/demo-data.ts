...
export const demoSnapshot: DashboardSnapshot = {
  ...
  highScoreCount: 0,
  marketRegime: {
    runId: "demo-not-published",
    marketDate: "2026-08-14",
    methodologyVersion: "regime-v1.0.0",
    label: "NEUTRAL",
    score: 54.8,
    benchmarkClose: 1588.42,
    benchmarkSma50: 1581.77,
    benchmarkSma200: 1569.31,
    benchmarkSma50Slope20: 0.006,
    benchmarkSma200Slope20: 0.011,
    benchmarkReturn20: 0.014,
    benchmarkRealizedVolatility20: 0.168,
    breadthAbove20: 0.52,
    breadthAbove50: 0.49,
    breadthAbove200: 0.46,
    breadthMomentum: 0.03,
    newHighRate: 0.041,
    newLowRate: 0.029,
    volumeParticipationRate: 0.47,
    sectorPositiveRate: 0.50,
    benchmarkTrendScore: 70,
    breadthScore: 49.6,
    sectorBreadthScore: 50,
    participationScore: 47,
    volatilityScore: 79.1,
    minimumQuantScore: 84,
    maxEquityExposure: 0.65,
    newPositionSizeMultiplier: 0.75,
    minimumCashAllocation: 0.35,
    maxNewEntries: 2,
    trendWeightMultiplier: 1,
    explanation: {
      policy: "Illustrative Phase 3 guidance only.",
    },
  },
  issues: [
    {
